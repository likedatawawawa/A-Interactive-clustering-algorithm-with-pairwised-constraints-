...
def iteration_stage_user_vote_thread_asy(max_uncertain_xi_list, query_list_dict, users_list, true_label, query_times,
                                                  neighborhood,min_users_num, max_users_num,user_locks,constraints_num,isUpdate,neighbourhoods_lock,stop_event=None):
